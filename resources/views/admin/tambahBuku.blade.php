                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahBuku') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary" name="kodeBuku" required value="{{ old('kodeBuku') }}">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary" name="judulBuku" required value="{{ old('judulBuku') }}">
                                <span class="text-danger">
                                    @error('judulBuku')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary" name="penulis" required value="{{ old('penulis') }}">
                                <span class="text-danger">
                                    @error('penulis')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary" name="penerbit" required value="{{ old('penerbit') }}">
                                <span class="text-danger">
                                    @error('penerbit')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="date" class="form-control border border-secondary" name="tahunTerbit" required value="{{ old('tahunTerbit') }}">
                                <span class="text-danger">
                                    @error('tahunTerbit')
                                        {{ $message }}
                                    @enderror
