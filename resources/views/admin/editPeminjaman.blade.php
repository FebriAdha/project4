                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditPeminjaman/{{ $data->id }}" method="POST">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary" name="idUser" required value="{{ $data->id_user }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="kodeBuku" required value="{{ $data->id_buku }}">
                                <span class="text-danger">
                                    @error('kodeBuku')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="tanggalPeminjaman" required value="{{ $data->tanggal_pinjam }}">
                                <span class="text-danger">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary" name="tanggalPengembalian" required value="{{ $data->tanggal_kembali }}">
                                <span class="text-danger">
                            ...
                            <br>
                            <div class="form-group mt-1">
                                <label class="text-secondary">Pilih Status</label><br>
