            ...
            <tbody class="table-group-divider">
                @foreach ($data as $index => $buku)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-warning" href="/admin/editBuku/{{ $buku->id }}"><i class="fas fa-edit"></i>Edit</a>
                            <a class="btn btn-outline-danger" href="/admin/deleteBuku/{{ $buku->id }}"><i class="fas fa-trash-alt"></i>Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
