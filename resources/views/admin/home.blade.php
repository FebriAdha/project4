            ...
            <tbody class="table-group-divider"> 
                @foreach ($data as $index => $userAdmin) 
                    <tr> 
                        ...
                        <td> 
                            <a class="btn btn-outline-warning" href="/editAdmin/{{ $userAdmin->id }}"><i class="fas fa-edit"></i>Edit</a> 
                            <a class="btn btn-outline-danger" href="/deleteAdmin/{{ $userAdmin->id }}"><i class="fas fa-trash-alt"></i>Delete</a> 
                        </td> 
                    </tr> 
                @endforeach 
            </tbody> 
